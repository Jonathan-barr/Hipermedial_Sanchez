...
<body id="page-top">
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top " id="mainNav">
        <div class="container">
            <a class="masthead-subheading text-uppercase" href="index.php">UNIDAD EDUCATIVA PARTICULAR ANDREW</a>
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="container text-white">
                        <p class="lead">Listado de empleados de la institucion
                        </p>
                        <b>
                            <p>
                                TOP 10 de los mejores empleados de la institucion <a href="top.php">Click Aquí</a>
                            </p>
                        </b>
    ...
    <div class="container-fluid">
        <div id="contratar">
            <div class="row">
                                ...
                                <li>
                                    ...
                                    <ul class="collapse list-unstyled" id="pageSubmenu4">
                                        ...
                                        <li><a href="" id="transportacion"><span
                                                    class="fa fa-chevron-right mr-2"></span> Limpieza</a></li>
                                ...
                                <li>
                                    ...
                                    <ul class="collapse list-unstyled" id="pageSubmenu3">
                                        <li><a href="" id='quito'><span
                                                    class="fa fa-chevron-right mr-2"></span>Napo</a></li>
                                        <li><a href="" id='guayaquil'><span
                                                    class="fa fa-chevron-right mr-2"></span>Valle</a></li>
                                        <li><a href="" id='cuenca'><span
                                                    class="fa fa-chevron-right mr-2"></span>Camal</a></li>
                                    </ul>
                                </li>
                            </ul>
                ...
                <div class="col-sm-12 col-md-8 col-lg-9">
                    <h1 class="display-4 text-center"><b>Empleados</b></h1>
        ...
        <div id="uio">
            <div class="container">
                <h1 class="display-4 text-center"><b>Usuarios en Napo:</b></h1>
                <a href="clientes.php" class="btn btn-sm bg-dark text-warning"><i class="fas fa-chevron-left"></i> Regresar</a>                          
        ...
        <div id="gye">
            <div class="container">
                <h1 class="display-4 text-center"><b>Usuarios en Valle:</b></h1>
                <a href="clientes.php" class="btn btn-sm bg-dark text-warning"><i class="fas fa-chevron-left"></i> Regresar</a>                          
        ...
        <div id="cue">
            <div class="container">
                <h1 class="display-4 text-center"><b>Usuarios en Camal:</b></h1>
                <a href="clientes.php" class="btn btn-sm bg-dark text-warning"><i class="fas fa-chevron-left"></i> Regresar</a>                          
