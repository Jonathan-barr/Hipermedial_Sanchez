...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand bg-info">
        <a class="navbar-brand text-uppercase" href=""><img src="assets/img/imagenes/logo.png" alt="LOGO" style="width: 20%"></a>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-md-3">
                            <div class="card bg-primary text-white mb-4">
                                <div class="card-body text-uppercase text-center">Total de Docentes Registrados</div>
                        ...
                        <div class="col-sm-6 col-md-3">
                            <div class="card bg-success text-white mb-4">
                                <div class="card-body text-uppercase text-center">total de visitas a perfiles de los docentes</div>
                                <div class="card-footer text-center">
                                <?php
            ...
            <footer class="py-4 bg-light mt-auto">
                <div class="container-fluid">
                    <div class="d-flex align-items-center justify-content-between small">
                        <div class="text-muted">Copyright &copy; Andrew </div>
                        <div>
