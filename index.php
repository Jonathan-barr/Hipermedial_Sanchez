...
$persona = array(
    ...
    'asunto' => 'Mas Información sobre matriculas',
    'msg' => 'Se requiere mayor información matriculas',
    'fono' => '5930983533898'
    )
);                   
?>
...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
        <div class="container">
            <a class="masthead-subheading text-uppercase" href="#page-top">Unidad Educativa Particular Andrew</a>
    ...
    <header class="masthead">
        ...
        <div class="alert container-fluid">
            <p class="py-3" style="display: unset;background: #5484DA;">
        ...
        <div class="container">
            <div class="row align-items-end">
                <div class="col-sm-12 col-md-12 col-lg-7">
                    ...
                    <img style="width: 50%" src="assets/img/imagenes/logo.png">
    ...
    <section class="page-section bg-light" id="services">
        <div class="container">
            <div class="text-center">
                ...
                <h3 class="section-subheading text-muted">Mira los servicios que nuestra institucion te puede ofrecer</h3>
            </div>
            <div class="row">
                <div class="col-lg-4 col-sm-6 mb-4">
                    <div class="servicios-img">
                        <img class="mx-auto " src="assets/img/servicios/1.jpg" alt="" />
                        <h3 class="section-subheading text-muted text-center py-4 text-uppercase">Excelencia Educativa<br>
                ...
                <div class="col-lg-4 col-sm-6 mb-4">
                    <div class="servicios-img">
                        ...
                        <h3 class="section-subheading text-muted text-center py-4 text-uppercase">Charlas motivacionales<br>
                ...
                <div class="col-lg-4 col-sm-6 mb-4">
                    <div class="servicios-img">
                        ...
                        <h3 class="section-subheading text-muted text-center py-4 text-uppercase">Inscripciones Abiertas<br>
                ...
                <div class="col-lg-4 col-sm-6 mb-4 mb-lg-0">
                    <div class="servicios-img">
                        ...
                        <h3 class="section-subheading text-muted text-center py-4 text-uppercase">Ofertas<br>
                ...
                <div class="col-lg-4 col-sm-6 mb-4 mb-sm-0">
                    <div class="servicios-img">
                        ...
                        <h3 class="section-subheading text-muted text-center py-4 text-uppercase">Patios recreativos<br>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="servicios-img">
                        ...
                        <h3 class="section-subheading text-muted text-center py-4 text-uppercase"> Sedes en sur y valle<br>
                        </h3>
        ...
        <div class="container">
            <div class="text-center">
                ...
                <div class="row">
                    <div class="col-lg-8 mx-auto text-center">
                        <p class="large text-muted">Equipo de soporte técnico
                        </p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-6 col-md-4">
                    <div class="team-member">
                        <img class="mx-auto rounded-circle" src="assets/img/team/seb.jpg" alt="" />
                        <h4>Sebastián Córdova</h4>
                        <p class="text-muted">Lead Designer</p>
                        <a class="btn btn-dark btn-social mx-2" href="https://github.com/SVINFYLKING" target="_blank"><i
                                class="fab fa-github"></i></a>
                        <a class="btn btn-dark btn-social mx-2" href="https://www.facebook.com/asyas.asyas.5623/"
                            target="_blank"><i class="fab fa-facebook-f"></i></a>
                    </div>
                </div>
                <div class="col-sm-6 col-md-4">
                    <div class="team-member">
                        <img class="mx-auto rounded-circle" src="assets/img/team/benja.jpg" alt="" />
                        <h4>Benjamin Ríos</h4>
                        <p class="text-muted">Lead Developer</p>
                        <a class="btn btn-dark btn-social mx-2" href="https://github.com/benjhamxn"><i
                ...
                <div class="col-sm-12 col-md-4">
                    <div class="team-member">
                        ...
                        <img class="mx-auto rounded-circle" src="assets/img/team/caro.jpg" alt="" />
                        <h4>Carolina Sanchez</h4>
                        <p class="text-muted">Lead Marketer </p>
                        <a class="btn btn-dark btn-social mx-2" href="https://github.com/aly9899"><i
                                class="fab fa-github" target="_blank"></i></a>
                        <a class="btn btn-dark btn-social mx-2" href="https://www.facebook.com/JCaroSanchezl"><i
            ...
            <div class="row">
                <div class="col-sm-6 col-md-6">
                    <div class="team-member">
                        <img class="mx-auto rounded-circle" src="assets/img/team/omi.jpg" alt="" />
                        <h4>Omar Vinueza</h4>
                        <p class="text-muted">C.F.O</p>
                        <a class="btn btn-dark btn-social mx-2" href="https://www.facebook.com/omar.vinueza.1"
                            target="_blank"><i class="fab fa-facebook-f"></i></a>
    ...
    <section class="page-section" id="contact">
        <div class="container">
            ...
            <form id="contactForm" action="mailto:isacorecal@outlook.com" method="POST" enctype="UTF-8">
    ...
    <footer class="footer py-4">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-sm-3 col-md-4 col-lg-4 text-lg-left">Copyright © Andrew</div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer d-flex justify-content-center">
                    <div class="signup-section"> <a id="iniciar" data-toggle="modal"
                                ...
                                <form id='formulario' class="formulario1" name='formularioregistrar' method='POST'>
                                    <div class="form-group">
                                        ...
                                        <select name="servicio" class="form-control">
                                            <option value="">Labor a desempeñar en la institución:</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="lugar" class="form-control">
                                            <option value="">Sede en la que vas a trabajar:</option>
                                            <?php foreach ($ejecutar as $opciones):?>
