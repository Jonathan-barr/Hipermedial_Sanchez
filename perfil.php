...
$persona = array(
    ...
    'msg' => 'Se requiere mayor información sobre las matriculas de la institucion',
    'fono' => '5930983533898'
    )
);
...
if(empty($_REQUEST['id'])){
    ...
    $mail_usuario = array(
        'info' => array(
        'correo' =>  $row['CORREO'],
        'asunto' => 'Información docente',
        'msg' => 'Me gustaría saber la calificacion de mi hijo',
